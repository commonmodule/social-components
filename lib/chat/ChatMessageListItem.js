...
export default class ChatMessageListItem extends DomNode {
    ...
    constructor(messageManager, messageGroup) {
        ...
        this.append(el(".avatar", new AuthorAvatarDisplay(messageGroup.author)), el("main", el(".author", new AuthorNameDisplay(messageGroup.author)), this.displayGroup = new ChatMessageContentDisplayGroup(messageManager, messageGroup)));
