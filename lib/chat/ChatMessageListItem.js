...
export default class ChatMessageListItem extends DomNode {
    messageGroup;
    displayGroup;
    constructor(contentDisplayManager, messageGroup) {
        super("li.chat-message-list-item");
        this.messageGroup = messageGroup;
        this.append(el(".avatar", new AuthorAvatarDisplay(messageGroup.author)), el("main", el(".author", new AuthorNameDisplay(messageGroup.author)), this.displayGroup = new ChatMessageContentDisplayGroup(contentDisplayManager, messageGroup.messages)));
